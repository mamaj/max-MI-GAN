...
normal_distribution = Normal(b, 1)
method = ScoreFunction("e", n_samples=200, baseline_factory='moving_average')
...
print("Score function n=100")
estimate_variance(ScoreFunction("e", n_samples=100))

print("Score function with baseline n=100")
estimate_variance(ScoreFunction("e", n_samples=100, baseline_factory="batch_average"))